...
const Create = () => {
  ...
  const submitHandler = (e) => {
    ...
    let contact = {id: Date.now(), name, email, phone};
  ...
  return (
    <form onSubmit={submitHandler} className=' w-96 border-2 p-5 rounded-xl mt-20 mx-auto drop-shadow'>
      ...
      <h1 className=' text-gray-800 font-bold text-2xl'>Create New Contact</h1>
      ...
      <div className=" flex gap-3">
        <button type='submit' className=' text-white bg-gray-800 px-4 py-2 rounded shadow-lg my-5 uppercase text-sm'>create</button>
        <Link to={'/'}>
